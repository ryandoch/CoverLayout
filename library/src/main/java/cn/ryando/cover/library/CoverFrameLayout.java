...
/**
 * Created by zhongkun on 2017/8/2.
 */
public class CoverFrameLayout extends FrameLayout {
    ...
    public CoverFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);

    }

    public CoverFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public CoverFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        leftTopRadius = leftBottomRadius = rightTopRadius = rightBottomRadius = a.getDimensionPixelSize(R.styleable
                .CoverFrameLayout_cover_radius, 0);
        leftTopRadius = a.getDimensionPixelSize(R.styleable.CoverFrameLayout_cover_leftTopRadius, leftTopRadius);
        rightTopRadius = a.getDimensionPixelSize(R.styleable.CoverFrameLayout_cover_rightTopRadius, rightTopRadius);
        leftBottomRadius = a.getDimensionPixelSize(R.styleable.CoverFrameLayout_cover_leftBottomRadius, leftBottomRadius);
        rightBottomRadius = a.getDimensionPixelSize(R.styleable.CoverFrameLayout_cover_rightBottomRadius, rightBottomRadius);
        a.recycle();
